...
class KitchenItems extends Resource
{
    ...
    public function fields(): array
    {
        return [
            ...
            Input::make('now_stock')
                ->title('Now stock')
                ->type('number')
                ->required(),

            Input::make('min_stock')
                ->title('Min stock')
                ->type('number')
                ->required(),
    ...
    public function columns(): array
    {
        return [
            ...
            TD::make('now_stock', 'Now stock'),

            TD::make('min_stock', 'Min stock'),
    ...
    public function legend(): array
    {
        return [
            ...
            Sight::make('now_stock', 'Now stock'),
            Sight::make('min_stock', 'Min stock'),
