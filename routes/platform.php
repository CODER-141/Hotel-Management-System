...
Route::screen('restaurant/menu', \App\Orchid\Screens\Restaurant\RestaurantMenuListScreen::class)
    ->name('platform.restaurant.menu')
    ->breadcrumbs(fn(\Tabuna\Breadcrumbs\Trail $trail) => $trail
        ->parent('platform.index')
        ->push(__('Restaurant Menu'), route('platform.restaurant.menu')));
